# Generated by Django 5.2.4 on 2025-07-23 19:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='Email address', max_length=255, unique=True, verbose_name='Email')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receiver', models.ForeignKey(help_text='The user who receives the message.', on_delete=django.db.models.deletion.CASCADE, related_name='received_by', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            name='MessageHistory',
            fields=[
                ('messageHistory_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('content', models.TextField(help_text='The content of the message.')),
                ('edited_at', models.DateTimeField(auto_now_add=True)),
                ('edited_by', models.ForeignKey(help_text='The user.', on_delete=django.db.models.deletion.CASCADE, related_name='Editor', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edited', models.BooleanField(default=False, help_text='check if message is edited')),
                ('message', models.ForeignKey(help_text='The sent message.', on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='messaging.message')),
                ('receiving_user', models.ForeignKey(help_text='The user.', on_delete=django.db.models.deletion.CASCADE, related_name='User', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
